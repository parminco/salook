        ...
        <div class="row">
            <div class="page-header">
                <div class="d-flex align-items-center">
                    <h2 class="page-header-title">ویرایش دسته بندی
                ...
                <div class="widget has-shadow" style="min-height: 500px">
                    <div class="widget has-shadow">
                        <div class="widget-header bordered no-actions d-flex align-items-center">
                            ...
                            <img class="image-slider" src="public/images/category/<?=$categoryInfo['id']?>.jpg" width="100" alt="تصویر">
                        </div>

                            <div class="widget-body">
                                <form method="post" action="admincategory/editcategory/<?=$categoryInfo['id']?>" class="needs-validation was-validated" novalidate=""  enctype="multipart/form-data" >

                                    <div class="form-group row d-flex align-items-center mb-5">
                                        <label class="col-lg-4 form-control-label d-flex justify-content-lg-end">عنوان *</label>
                                        <div class="col-lg-5">
                                            <input name="title" type="text" class="form-control" placeholder="عنوان" value="<?=$categoryInfo['title']?>">
                                    ...
                                    <div class="form-group row d-flex align-items-center mb-5">
                                        ...
                                        <span style="text-align: center;font-size: 9pt;width: 100%;margin-top: 3px">
                                            تصویر اسلایدر نمیتواند خالی باشد (400px در 300px)
                                        </span>
                                    </div>
