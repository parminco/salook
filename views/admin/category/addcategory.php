        ...
        <div class="row">
            <div class="page-header">
                <div class="d-flex align-items-center">
                    <h2 class="page-header-title">افزودن دسته بندی</h2>
                    <div>
                    ...
                    <div class="widget has-shadow">
                        <div class="widget-header bordered no-actions d-flex align-items-center">
                            ...
                            <div class="widget-body">
                                <form method="post" action="admincategory/addcategory" class="needs-validation was-validated" novalidate=""  enctype="multipart/form-data" >
                                    ...
                                    <div class="form-group row d-flex align-items-center mb-5">
                                        ...
                                        <div class="col-lg-5">
                                            ...
                                            <div class="invalid-feedback">
                                               عنوان دسته بندی نمیتواند خالی باشد
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row d-flex align-items-center mb-5">
                                        ...
                                        <div class="col-lg-5">
                                            ...
                                            <div class="invalid-feedback">
                                              تصویر دسته بندی نمیتواند خالی باشد (400px در 300px)
