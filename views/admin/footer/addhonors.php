        ...
        <div class="row">
            <div class="page-header">
                <div class="d-flex align-items-center">
                    <h2 class="page-header-title">افزودن افتخار </h2>
                    <div>
                ...
                <div class="widget has-shadow" style="min-height: 500px">
                    <div class="widget has-shadow">
                        ...
                        <div class="widget-body">
                            <form method="post" action="adminfooter/addhonors" class="needs-validation was-validated"
                                ...
                                <div class="form-group row d-flex align-items-center mb-5">
                                    <label class="col-lg-4 form-control-label d-flex justify-content-lg-end">تاریخ دریافت *</label>
                                    <div class="col-lg-5">
                                        <input name="date_received" type="text" class="form-control" placeholder="تاریخ دریافت" required="">
                                        <div class="invalid-feedback">
