...
$honorsInfo = $data['honorsInfo'];

if (isset($_GET['editHonors'])) {
    ?>
                ...
                <div class="widget has-shadow" style="min-height: 500px">
                    <div class="widget has-shadow">
                        <div class="widget-header bordered no-actions d-flex align-items-center">
                            ...
                            <img class="image-box" src="public/images/honors/<?=$honorsInfo['id']?>.jpg" width="50">
                        </div>

                        <div class="widget-body">
                            <form method="post" action="adminfooter/edithonors/<?=$honorsInfo['id']?>" class="needs-validation was-validated"
                                ...
                                <div class="form-group row d-flex align-items-center mb-5">
                                    <label class="col-lg-4 form-control-label d-flex justify-content-lg-end">عنوان
                                        *</label>
                                    <div class="col-lg-5">
                                        <input name="title" type="text" class="form-control" placeholder="عنوان" required="" value="<?=$honorsInfo['title']?>">
                                ...
                                <div class="form-group row d-flex align-items-center mb-5">
                                    <label class="col-lg-4 form-control-label d-flex justify-content-lg-end">تاریخ دریافت
                                        *</label>
                                    <div class="col-lg-5">
                                        <input name="date_received" type="text" class="form-control" placeholder="تاریخ دریافت" required="" value="<?=$honorsInfo['date_received']?>">
                                        <div class="invalid-feedback">
                                            تاریخ دریافت نمیتواند خالی باشد
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row d-flex align-items-center mb-5">
                                    <label class="col-lg-4 form-control-label d-flex justify-content-lg-end">توضیحات
                                        *</label>
                                    <div class="col-lg-5">
                                        <input name="description" type="text" class="form-control" placeholder="توضیحات" required="" value="<?=$honorsInfo['description']?>">
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-group row d-flex align-items-center mb-5">
                                    ...
                                    <div class="col-lg-5">
                                        <input name="image" type="file" class="form-control" placeholder="تصویر(500px در 500px)"  value="public/images/honors/<?=$honorsInfo['id']?>.jpg">
                                    </div>
                                </div>
